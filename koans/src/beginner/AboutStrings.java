...
public class AboutStrings {
    ...
    public void stringCompareIgnoreCase() {
        ...
        assertEquals(str.compareToIgnoreCase("I am a number one!") == 0, true);
        assertEquals(str.compareToIgnoreCase("I AM A NUMBER ONE!") == 0, true);
        //porównuje bez znaczenia wielkosci liter, gdy prawda zwraca 0
    }
    ...
    public void stringSubstring() {
        ...
        assertEquals(str.substring(14, 17), "ONE"); //14ty znak ..15 ..16 i 17 czyli powinno byc
        // razem ze znakiem !
    ...
    } //jak sprawdzić jaka to bedzie klasa i jaka wiadomość?
