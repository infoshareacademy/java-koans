...
public class AboutPrimitives {
    ...
    public void integersHaveAFairlyLargeRange() {
        assertEquals(Integer.MIN_VALUE, (int)Math.pow(-2,31));
        assertEquals(Integer.MAX_VALUE, (int)Math.pow(2,31));
    }
    ...
    public void longsHaveALargerRangeThanInts() {
        assertEquals(Long.MIN_VALUE, (long)(Math.pow(-2,63)-1));
        assertEquals(Long.MAX_VALUE, (long)(Math.pow(2,63)));
    }
    ...
    public void shortsHaveASmallerRangeThanInts() {
        assertEquals(Short.MIN_VALUE, (short)(Math.pow(2,15)));  // hint: You'll need an explicit cast
        assertEquals(Short.MAX_VALUE, (short)(Math.pow(2,15)-1));
    }
    ...
    public void bytesHaveASmallerRangeThanShorts() {
        assertEquals(Byte.MIN_VALUE, (byte)Math.pow(-2,7));
        assertEquals(Byte.MAX_VALUE, (byte)(Math.pow(2,7)-1));
    ...
    public void primitivesOfTypeDoubleCanBeDeclaredWithExponents() {
        ...
        assertEquals(1.0e3, 1000d);
        assertEquals(1E3, 1000d);
    }
    ...
    public void doublesHaveALargeRange() {
        assertEquals(Double.MIN_VALUE, (double)Math.pow(2,-1074));
        assertEquals(Double.MAX_VALUE, (double)((2-Math.pow(2,-52))*Math.pow(2,1023)));
    }
    ...
    public void floatsHaveASmallerRangeThanDoubles() {
        assertEquals(Float.MIN_VALUE, (float)Math.pow(2,-149));
        assertEquals(Float.MAX_VALUE, (float)((2-Math.pow(2,-23))*Math.pow(2,127)));
    }
