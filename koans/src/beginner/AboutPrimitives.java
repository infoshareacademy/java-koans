...
public class AboutPrimitives {
    ...
    public void longsHaveALargerRangeThanInts() {
        assertEquals(Long.MIN_VALUE, (long) -Math.pow(2, 63));
    ...
    public void shortsHaveASmallerRangeThanInts() {
        assertEquals(Short.MIN_VALUE, (short) -java.lang.Math.pow(2, 15));  // hint: You'll need an explicit cast
        assertEquals(Short.MAX_VALUE, (short) (java.lang.Math.pow(2, 15)-1));
    }
    ...
    public void bytesHaveASmallerRangeThanShorts() {
        assertEquals(Byte.MIN_VALUE, (byte) -java.lang.Math.pow(2, 7));
        assertEquals(Byte.MAX_VALUE, (byte) (-java.lang.Math.pow(2, 7)-1));
    ...
    public void doublesHaveALargeRange() {
        assertEquals(Double.MIN_VALUE, Math.pow(2, -1074));
        assertEquals(Double.MAX_VALUE, (2-Math.pow(2,-52))*Math.pow(2,1023));
    }
