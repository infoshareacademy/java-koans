...
public class AboutPrimitives {
    ...
    public void wholeNumbersCanAlsoBeOfTypeShort() {
        assertEquals(getType((short) 1), short.class); // The '(short)' is called an explicit cast -
        // to
        // type 'short'
    }
    ...
    public void floatsHaveASmallerRangeThanDoubles() {
        assertEquals(Float.MIN_VALUE, (float) 1.4E-45);
        assertEquals(Float.MAX_VALUE, (float) 3.4028235E38);
    }
